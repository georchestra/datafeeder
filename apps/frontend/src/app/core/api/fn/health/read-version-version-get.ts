...
export function readVersionVersionGet(http: HttpClient, rootUrl: string, params?: ReadVersionVersionGet$Params, context?: HttpContext): Observable<StrictHttpResponse<any>> {
