...
export function listGroupsDataGroupsGet(http: HttpClient, rootUrl: string, params?: ListGroupsDataGroupsGet$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<GroupItem>>> {
