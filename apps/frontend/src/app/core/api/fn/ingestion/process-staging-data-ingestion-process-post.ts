...
export function processStagingDataIngestionProcessPost(http: HttpClient, rootUrl: string, params: ProcessStagingDataIngestionProcessPost$Params, context?: HttpContext): Observable<StrictHttpResponse<ProcessResponse>> {
  const rb = new requestBuilders(rootUrl, processStagingDataIngestionProcessPost.PATH, 'post');
  if (params) {
