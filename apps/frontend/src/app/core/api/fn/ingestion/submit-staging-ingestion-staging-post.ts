...
export function submitStagingIngestionStagingPost(http: HttpClient, rootUrl: string, params: SubmitStagingIngestionStagingPost$Params, context?: HttpContext): Observable<StrictHttpResponse<StagingResponse>> {
  const rb = new requestBuilders(rootUrl, submitStagingIngestionStagingPost.PATH, 'post');
  if (params) {
