...
export function getDagRunByIntlinkAirflowDagsDagIdRunsIntlinkIdGet(
  http: HttpClient,
  rootUrl: string,
  params: GetDagRunByIntlinkAirflowDagsDagIdRunsIntlinkIdGet$Params,
  context?: HttpContext
): Observable<StrictHttpResponse<DagRunCollectionResponse>> {
  const rb = new requestBuilders(
    rootUrl,
    getDagRunByIntlinkAirflowDagsDagIdRunsIntlinkIdGet.PATH,
    'get'
  )
  if (params) {
...
getDagRunByIntlinkAirflowDagsDagIdRunsIntlinkIdGet.PATH =
  '/airflow/dags/{dag_id}/runs/{intlink_id}'
