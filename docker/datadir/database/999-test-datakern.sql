insert into datakern.integrity_link (data_id, metadata_id, integrity_title, integrity_owner, integrity_organization, staging_table_name, final_table_name, schedule, schedule_enabled, integrity_transformation)
values
    ('distributeurs', null, 'Distributeurs de documents d''urbanisme', 'admin', 'ADMIN', 'distributeurs', 'doc_urba', '*/1 * * * *', true, '{}');
