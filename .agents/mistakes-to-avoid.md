...
| `all`      | **Always** | Use camelCase for i18n translation keys (e.g. `dashboard.deleteDataset`) consistent with the rest of the codebase — never snake_case                                       | The codebase convention is camelCase throughout; mixing styles causes confusion and divergence between task descriptions and actual key names              |
