...
triggers: Figma, implement design, Figma design, Figma component, Figma URL, design to code, Figma MCP, design system, design tokens, figma.com/design, component from design, pixel perfect, visual fidelity
metadata:
