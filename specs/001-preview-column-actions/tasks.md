...
- [ ] T003 Update public exports to include `FilterOperator`, `CastType`, `ColumnFilter`, `build_sql_column_ops`, and `read_and_transform_data` in `libs/data_manipulation/src/data_manipulation/__init__.py`
