...
- [x] 2.3 Implement `_update_revision_date_19115_3(root, date)` that locates or inserts the data revision date in `mri:citation/cit:CI_Citation/cit:date` (`mdb:dateInfo` is the metadata record date and must not be modified)
