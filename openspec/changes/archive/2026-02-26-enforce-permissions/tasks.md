...
- [x] 7.3 Manual verification: test all acceptance scenarios from the spec with different user roles (admin, owner, METADATA_WRITE group member, METADATA_READ group member, no-permission user)
