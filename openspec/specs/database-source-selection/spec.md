...
Frontend UI for selecting the database source type (radio button conditional on feature flag), entering schema and table name, and submitting to the backend.
